...
const ProjectCard = ({
  ...
  return (
    <div className="grid grid-rows-[min-content_min-content] min-[900px]:grid-rows-2 border border-zinc-300 dark:border-zinc-600 shadow-sm dark:shadow-zinc-950 rounded-md z-10">
      <div className="relative rounded-t-md aspect-video h-min">
        <img
