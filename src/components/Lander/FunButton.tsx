const FunButton = () => {
  return (
    <button className="grid justify-items-center">
      <div className="grid grid-rows-[min-content,_1fr] w-36 md:w-56 aspect-[9_/_7] bg-neutral-300 border-2 border-black rounded-md">
        <div className="relative w-[80%] aspect-[4_/_3] bg-black justify-self-center mt-2 md:mt-4 mb-[5px] grid items-center rounded-md">
          <div
      ...
      <div className="w-16 md:w-24 aspect-[16_/_3] bg-neutral-300 border-2 border-t-0 border-b-0 border-black rounded-sm" />
      <div className="w-24 md:w-36 aspect-[12_/_1] bg-neutral-300 border-2 border-black rounded-sm" />
    </button>
  );
};
