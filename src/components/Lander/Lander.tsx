...
const Lander = () => {
  return (
    <div className="grid grid-rows-[min-content_repeat(2,_minmax(min-content,_1fr))] h-[max(100vh,_800px)] w-full bg-transparent text-neutral-950 dark:text-neutral-50">
      <TitleCard />
