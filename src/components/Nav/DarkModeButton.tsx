...
const DarkModeButton = () => {
  ...
  return (
    <button
      ...
      className="w-fit justify-self-end h-9 m-3 p-1 text-neutral-950 hover:text-green-500 dark:text-neutral-50 border-2 border-neutral-950 hover:border-green-500 dark:border-neutral-50 rounded-full aspect-square grid justify-center content-center"
    >
      {darkmode === "true" ? (
        <svg
