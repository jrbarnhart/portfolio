...
const Portrait = () => {
  return (
    <div className="relative group h-fit w-fit justify-self-center self-center md:row-span-2">
      <img
        src={portraitImage}
        alt="A cartoon portrait of Joshua Barnhart"
        className="h-52 md:h-64 rounded-3xl blur-none justify-self-center self-center shadow-lg shadow-black"
      />
