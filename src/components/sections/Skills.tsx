...
export default function Skills() {
  ...
  return (
    <div className="px-2 w-full flex flex-col items-center justify-self-center">
      <section
        id="skills"
        className="text-slate-950 dark:text-violet-50 px-2 pb-2 md:pb-6 md:px-6 py-4 w-full max-w-6xl bg-white/30 dark:bg-white/10 backdrop-blur-lg backdrop-saturate-150 rounded-2xl shadow-lg grid gap-4 md:grid-cols-2"
      >
        ...
        {skillData.map((data, index) => (
          <div
            className="px-4 py-4 bg-black/5 dark:bg-white/10 shadow-md shadow-indigo-950/50 dark:shadow-indigo-950 rounded-2xl transition hover:bg-white/10 dark:hover:bg-white/20 grid gap-4 content-start"
            key={index}
          >
