...
export default function About() {
  return (
    <section className="text-slate-950 dark:text-violet-50 px-6 mx-2 py-4 max-w-6xl justify-self-center bg-white/20 dark:bg-white/10 backdrop-blur-lg backdrop-saturate-150 rounded-2xl shadow-lg grid gap-2 md:grid-cols-[2fr_1fr] md:grid-rows-[repeat(3,min-content)]">
